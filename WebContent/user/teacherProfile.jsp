									...
									<div class="woocommerce">
										<form action="http://education.themerex.net/cart/"
											...
											<table class="shop_table cart" cellspacing="0">
												...
												<thead>
													<tr>
														<th class="product-remove">First Name</th>
														<th class="product-thumbnail">Middle Name</th>
														<th class="product-price">Last Name</th>
														<th class="product-thumbnail">Birth Date</th>
												...
												<tbody>
													...
													<c:forEach items="${sessionScope.TeacherProfileList}"
														...
														<tr class="cart_item">
															...
															<td class="product-remove">${k.firstName}</td>

															<td class="product-thumbnail">${k.middleName}</td>

															<td class="product-price">${k.lastName }</td>
															<td class="product-thumbnail">${k.birthDate}</td>

																<td class="product-price">${k.gender}</td>



																<td class="product-price">${k.phone}</td>
														
															
															
															
															<td class="product-remove">${k.address}</td>

														<td class="product-thumbnail">${k.city}</td>

														<td class="product-price">${k.country}</td>
														<td class="product-price">${k.postcode}</td>
											...
											<table class="shop_table cart" cellspacing="0">
												...
												<thead>
													<tr>
														...
														<th class="product-price">Password</th>
												...
												<tbody>
													...
													<c:forEach items="${sessionScope.userDetailList}"
														...
														<tr class="cart_item">
														<td class="product-price">${l.userName}</td>
															<td class="product-price">${l.password }</td>

															<td class="product-remove">${l.email}</td>
