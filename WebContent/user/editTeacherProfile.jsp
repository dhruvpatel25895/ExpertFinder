	...
	<div class="body_wrap">
									...
									<div class="wpb_column vc_column_container vc_col-sm-12">
										<div class="wpb_wrapper">
											<div class="woocommerce">
												...
												<c:forEach items="${sessionScope.TeacherProfileList}"
													var="k">
													<c:forEach items="${sessionScope.userDetailList}" var="l">

														<form method="post"
															action="${pageContext.request.contextPath}/TeacherRegistration?teacherRegistrationId=${k.teacherRegistrationId}"
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-10">
																				<input class="form-control" type="date"
																					...
																					value="${k.birthDate}" type="text" required /> <span
	 ...
	 -->
																		...
																		<p
																			...
																			Female&nbsp&nbsp&nbsp<input type="radio"
																		...
																		<p
																			...
																			<label for="billing_postcode" class="">Postcode
																				...
																				name="postcode" id="postcode" placeholder="Postcode"
																				value="${k.postcode}" />
																		</p>
																		<div class="clear"></div>
																		...
																		<input type="hidden" name="flag"
																			value="updateTeacherDetails"> <input
																			type="submit" class="button alt" value="Submit"
