...
<title>Teacher Qualification</title>
		...
		<div class="page_wrap">
			...
			<div class="page_top_wrap page_top_title page_top_breadcrumbs"
				...
				<div class="content_wrap">
					...
					<h1 class="page_title">Teacher Qualification Document</h1>
				</div>
			</div>
									...
									<div class="wpb_column vc_column_container vc_col-sm-12">
										<div class="wpb_wrapper">
											<div class="woocommerce">
												...
												<form form id="teacherQualificationForm"
													name="teacherQualificationForm" method="post"
													action="${pageContext.request.contextPath}/TeacherQualification"
														...
														<div class="col-1">
															<div class="woocommerce-billing-fields">
																...
																<p style="float: left; width: 100%;"
																	...
																	<label for="billing_first_name" class="">School/Collage/Institute
																		Name <abbr class="required" title="required">*</abbr>
																	</label><input type="text" class="input-text "
																		name="instituteName" id="instituteName" placeholder=""
																		value="" />
																</p>
																<div class="clear"></div>
																...
																<p style="float: left; width: 100%;"
																	class="form-row form-row form-row-first validate-required"
																	id="billing_first_name_field">
																	<label for="billing_first_name" class="">Year
																		of Experience <abbr class="required" title="required">*</abbr>
																	</label><input type="text" class="input-text "
																...
																<p style="float: left; width: 100%;"
																	...
																	<label for="billing_last_name" class="">
																		Experience Description <abbr class="required"
																		title="required">*</abbr>
																	</label>
																	<textarea class="input-text "
																		name="experienceDescription"
																		id="experienceDescription" placeholder="" value=""> </textarea>
																</p>
																<div class="clear"></div>
																...
																<p style="float: left; width: 100%;"
																	class="form-row form-row form-row-first validate-required"
																	id="billing_last_name_field">
																	<label for="billing_last_name" class=""> File
																		Description <abbr class="required" title="required">*</abbr>
																	</label>
																	<textarea class="input-text " name="fileDescription"
																		id="\" placeholder="" value=""> </textarea>
																</p>
																<div class="clear"></div>
																...
																<p style="float: left; width: 100%;"
																	...
																	<label for="billing_first_name" class="">
																		Certificate<abbr class="required" title="required">*</abbr>
																	</label><input type="file" class="input-text "
																		name="certificate" id="certificate" placeholder=""
																		value="" />
																</p>
																<div class="clear"></div>
