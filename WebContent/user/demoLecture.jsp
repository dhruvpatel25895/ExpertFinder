		...
		<div class="page_wrap">
			...
			<div class="page_top_wrap page_top_title page_top_breadcrumbs"
				...
				<div class="content_wrap">
					...
					<h1 class="page_title">Demo Lecture</h1>
				</div>
			</div>
									...
									<div class="wpb_column vc_column_container vc_col-sm-12">
										<div class="wpb_wrapper">
											<div class="woocommerce">
												...
												<form method="post"
													action="${pageContext.request.contextPath}/TeacherRegistration?flag=insertDemoDetails"
														...
														<div class="col">
															<div class="woocommerce-billing-fields">
																...
																<p
																	...
																	<label for="billing_first_name" class="">Teacher
																		Name<abbr class="required" title="required">*</abbr>
																	</label><input type="text" class="input-text "
																		name="teacherName" id="teacherName" placeholder=""
																...
																<c:forEach items="${sessionScope.studentListForDemo}"
																	var="k">

																	<p
																		class="form-row form-row form-row-first validate-required"
																		id="billing_first_name_field">
																		<label for="billing_first_name" class="">Student
																			Name<abbr class="required" title="required">*</abbr>
																		</label><input type="text" class="input-text "
																			name="studentName" id="studentName" placeholder=""
																			value="${k.middleName}" />
																	</p>
																	<input type="hidden" name="studentId"
																		value="${k.loginVO.userId}" />
																</c:forEach>
																...
																<p
																	class="form-row form-row form-row-first validate-required"
																	id="billing_first_name_field">
																	<label for="billing_first_name" class="">Date <abbr
																		class="required" title="required">*</abbr>
																	</label><input type="date" class="input-text " name="date"
																		id="date" placeholder="" value="" required />
																</p>
																<div class="clear"></div>
																...
																<p
																	class="form-row form-row form-row-first validate-required"
																	id="billing_first_name_field">
																	<label for="billing_first_name" class="">Time <abbr
																		class="required" title="required">*</abbr>
																	</label><input type="text" class="input-text " name="time"
																		id="time" placeholder="" value="" required />
																</p>
																<div class="clear"></div>


																<c:forEach
																	items="${sessionScope.TeacherRequirementList}" var="var">
																	<input type="hidden" name="teacherRequirementId"
																		value="${var.teacherRequirementId}">
																</c:forEach>

																<c:forEach
																	items="${sessionScope.studentRequirementList}" var="l">



																	<input type="hidden" name="studentRequirementId"
																		value="${l.studentRequirementId}">
																</c:forEach>



																<%-- <input type="hidden" name="teacherRequirementId"
																			value="${j.teacherRequirementId}"> --%>
