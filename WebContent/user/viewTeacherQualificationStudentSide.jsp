...
<title>View Teacher Qualification For Student</title>
		...
		<div class="page_wrap">
			...
			<div class="page_top_wrap page_top_title page_top_breadcrumbs"
				...
				<div class="content_wrap">
					...
					<h1 class="page_title">Teacher Qualification</h1>
				</div>
			</div>
									...
									<div class="woocommerce">
										<form action="http://education.themerex.net/cart/"
											...
											<table class="shop_table cart" cellspacing="0">
												...
												<thead>
													<tr>
														<th class="product-remove">Institute Name</th>
														<th class="product-thumbnail">Experience Year</th>
														<th class="product-price">Experience Description</th>
												...
												<tbody>
													...
													<c:forEach items="${sessionScope.teacherDocumentList}"
														var="k">
														...
														<tr class="cart_item">
															...
															<td class="product-remove">${k.instituteName}</td>

															<td class="product-thumbnail">${k.experienceYear}</td>

															<td class="product-price">${k.experienceDescription}</td>
									...
									<div class="woocommerce">
										<form action="http://education.themerex.net/cart/"
											...
											<table class="shop_table cart" cellspacing="0">
												...
												<thead>
													<tr>
														<th class="product-remove">File Description</th>
														<th class="product-thumbnail">Certificate</th>
												...
												<tbody>
													...
													<c:forEach items="${sessionScope.teacherDocumentList}"
														var="k">
														<c:forEach items="${sessionScope.teacherFileList}"
															var="teacherFileList">

															<tr class="cart_item">

																<%--  <c:if
																	test="${k.teacherQualificationId eq teacherFileList.teacherQualificationFileUploadVO.teacherQualificationId}">
							 --%>
																<td class="product-remove">${teacherFileList.fileDescription}</td>


																<td class="product-thumbnail"><a
																	href="<%=request.getContextPath()%>/doc/${teacherFileList.fileName }"
																	download" /><img border="0"
																				
																				 />${teacherFileList.fileName}</a></td>
