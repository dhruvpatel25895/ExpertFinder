...
<script>
		function validate()
		{
			...
			var address=document.teacherRegistration.address.value;  
		...
		<div class="page_wrap">
			...
			<div class="page_top_wrap page_top_title page_top_breadcrumbs"
				...
				<div class="content_wrap">
					...
					<h1 class="page_title">Teacher Registration</h1>
				</div>
			</div>
									...
									<div class="wpb_column vc_column_container vc_col-sm-12">
										<div class="wpb_wrapper">
											<div class="woocommerce">
												...
												<form method="post" name="teacherRegistration"
													id="teacherRegistration"
													action="${pageContext.request.contextPath}/TeacherRegistration ">
														...
														<div class="col">
															<div class="woocommerce-billing-fields">
																...
																<p
																	...
																	</label><input type="text" class="input-text " name="firstName"
																...
																<!-- 	<p
																	class="form-row form-row form-row-first validate-required"
																	id="billing_last_name_field">
																	<label for="billing_last_name" class="">Confirm
																...
																<div class="form-group">
																	<label class="col-sm-2 control-label">Birth
																		Date</label>
																	<div class="col-sm-10">
																		<input class="form-control" type="date" id="birthDate"
																			name="birthDate" data-mask="99/99/9999"
																			placeholder="" type="text" required /> <span
	 ...
	 -->
																...
																<p
																	...
																	<label for="billing_first_name" class="">Gender
																		<abbr class="required" title="required">*</abbr>
																	</label> Male &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="radio"
																...
																<p
																	...
																	<textarea name="address" class="input-text "
																		id="address" placeholder="Enter Your Address" rows="2"
																		cols="5" onblur="validate()"></textarea>
																</p>
																...
																<p
																	...
																	<label for="billing_city" class="">Town / City
																		...
																		id="city" placeholder="Town / City" value="" required />
																</p>

																<p
																	class="form-row form-row form-row-first address-field validate-state"
																	id="billing_state_field">
																	<label for="billing_state" class="">County<abbr
																		class="required" title="required">*</abbr></label><input
																...
																<p
																	class="form-row form-row form-row-first address-field validate-state"
																	id="billing_city_field">
																	<label for="billing_city" class="">Postcode <abbr
																		class="required" title="required">*</abbr>
																	</label><input type="text" class="input-text " name="postcode"
																		id="postcode" placeholder="Postcode" value="" required />
																</p>
																...
																<input type="hidden" name="flag"
																	value="insertTeacherDetails"> <input
																	type="submit" class="button alt" id="place_order"
																	value="Submit" onsubmit="validate()"
