...
<body>
						...
						<tbody>
							<c:forEach items="${sessionScope.feedbackList}" var="i">
								...
								<tr class="gradeX">
									...
									<td>${i.toUserId.userName}</td>
									<td>${i.feedbackName}</td>
                  ...
                  --%>
										<%-- <form action="${pageContext.request.contextPath}/Feedback">
											...
											<button class="btn btn-danger" type="submit" name="flag"
												value="deleteFeedback">Delete</button> --%>
	...
	<!-- Right Slidebar end --> <!--footer start--> <jsp:include page="footer.jsp"></jsp:include> <!--footer end--> </section>
