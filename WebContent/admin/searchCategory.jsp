             ...
             <span class="tools pull-right">
              ...
              <tr class="gradeX">
                 ...
                 <!-- 	<input type="hidden" name="flag" value="delete"> -->
                  	...
                  	<button class="btn btn-success" name="flag" value="editCategory" type="submit">Edit</button>
                    <button class="btn btn-danger" type="submit" name="flag" value="deleteCategory">Delete</button>
