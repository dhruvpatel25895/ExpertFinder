             ...
             <span class="tools pull-right">
              ...
              <tr class="gradeX">
                 ...
                 <!-- 	<input type="hidden" name="flag" value="delete"> -->
                  	<input type="hidden" name="cityId" value="${i.cityId}">
                  	<button class="btn btn-success" name="flag" value="editCity" type="submit">Edit</button>
                    <button class="btn btn-danger" type="submit" name="flag" value="deleteCity">Delete</button>
