...
<body>
	...
	<jsp:include page="menu.jsp"></jsp:include> <!--sidebar end--> <!--main content start-->
	...
	<div class="row">
		<div class="col-sm-12">
			...
			</span> </header> <%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
			...
			<div class="panel-body">
				<div class="adv-table">
					<table class="display table table-bordered table-striped"
						...
						<tbody>
							<c:forEach items="${sessionScope.complainList}" var="i">
								...
								<tr class="gradeX">
									<td>${i.fromUserId.userName}</td>
									<td>${i.complainName}</td>
									<td>${i.complainDesc}</td>
									<td>
                  ...
                  --%>
										<form action="${pageContext.request.contextPath}/Complain">
											<!-- 	<input type="hidden" name="flag" value="delete"> -->
											<input type="hidden" name="complainId"
												value="${i.complainId}">
											<button class="btn btn-success" name="flag" value="*"
												type="submit">Action</button>
											<button class="btn btn-danger" type="submit" name="flag"
												value="deleteComplain">Delete</button>
	...
	<!-- Right Slidebar end --> <!--footer start--> <jsp:include
		page="footer.jsp"></jsp:include> <!--footer end--> </section>
