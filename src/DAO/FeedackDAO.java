...
public class FeedackDAO {
	...
	public List searchRating(LoginVO loginVO)
	{
		List l = null;
		try
		{
			...
			Query w=session.createQuery("from FeedbackVO where toUserId='"+loginVO.getUserId()+"'");
	...
	public List searchRatingForTeacher(LoginVO loginVO)
	{
		List l = null;
		try
		{
	...
	public List searchTeacherForFeedback(LoginVO loginVO)
	{
		List l = null;
		try
		{
	...
	/*public List editComplain(ComplainVO complainVO)
	{
		...
		try
		{
			...
			Query w=session.createQuery("from ComplainVO where id='"+complainVO.getComplainId()+"' ");
